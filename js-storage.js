...
(function(self, undefined) {
	...
	var saveStoredData = function(data) {
		...
		if(stringified.length > maxSize && !localStorage)
		{
			// Whoa, buddy
			throw 'Data greater than max cookie size of ' + maxSize + ' bytes';
		}
		...
		{
			setCookie(dataKeyName, stringified, 90);
		}
	};
